...
namespace ETL_Processor
{
    internal class Program
    {
        ...
        private static readonly string CSV_FILE_PATH = Path.Combine( "RawData", "sample-cab-data.csv");
        private static readonly string CSV_FILE_DUPLICATES_PATH = Path.Combine( "Duplicates", "duplicates.csv");
